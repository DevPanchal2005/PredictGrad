...
new_feature_impact = st.Page("pages/New_Feature_Impact.py", icon='🆕') # For SHAP with new features
...
pg = st.navigation({
    "Home": [home],
    "Analysis & Insights": [predict_student_risk, demo, feature_impact, new_feature_impact, data_insights], # Grouped prediction, SHAP, and EDA
